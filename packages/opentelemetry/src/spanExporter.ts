...
import { ATTR_HTTP_RESPONSE_STATUS_CODE, ATTR_HTTP_STATUS_CODE } from '@opentelemetry/semantic-conventions/incubating';
import {
  captureEvent,
...
function getData(span: ReadableSpan): Record<string, unknown> {
  ...
  const maybeHttpStatusCodeAttribute = attributes[ATTR_HTTP_STATUS_CODE];

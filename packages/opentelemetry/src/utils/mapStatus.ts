...
function inferStatusFromAttributes(attributes: SpanAttributes): SpanStatus | undefined {
  ...
  const httpCodeAttribute = attributes[ATTR_HTTP_RESPONSE_STATUS_CODE] || attributes[ATTR_HTTP_STATUS_CODE];
  const grpcCodeAttribute = attributes[ATTR_RPC_GRPC_STATUS_CODE];
